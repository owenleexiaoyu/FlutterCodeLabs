...
class Git {
  // 在网络请求过程中可能会需要使用当前的context信息，比如在网络请求失败时打开
  // 一个新路由，而打开新路由需要 context 信息
  Git([this.context]) {
    ...
    if (!Global.isRelease) {
      (dio.httpClientAdapter as DefaultHttpClientAdapter).onHttpClientCreate =
        ...
        client.findProxy = (uri) {
          return "PROXY 10.87.61.208:8888";
        };
  ...
  Future<List<Repo>> getRepos({
    required Map<String, dynamic> queryParameters, // query 参数，用于接受分页信息
    refresh = false
  }) async {
    if (refresh) {
