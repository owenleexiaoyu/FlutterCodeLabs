...
import 'package:flutter_app/pages/functional_widgets_page.dart';
...
import 'package:flutter_app/pages/scrollable_widgets_page.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                HomeItem(
                  title: "可滚动类 Widget 示例",
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                      return ScrollableWidgetsPage();
                    }));
                  },
                ),
                HomeItem(
