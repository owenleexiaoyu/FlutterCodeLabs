...
import 'package:video_player_app/video_play_page.dart';
...
class _HomePageState extends State<HomePage> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildYourProgramSliver(context),
            _buildBannerSliver(),
            _buildFocusAreaSliver(context),
          ],
        ),
      ),
    );
  ...
  Widget _buildYourProgramSliver(BuildContext context) {
    return Column(
      children: [
        Row(
          children: [
  ...
  Widget _buildFocusAreaSliver(BuildContext context) {
    return Expanded(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
